...
namespace MeetingScheduler.Web
{
    ...
    public sealed partial class SchedulerDomainContext : DomainContext
    {
        ...
        /// <summary>
        /// Gets the set of <see cref="sysdiagrams"/> entity instances that have been loaded into this <see cref="SchedulerDomainContext"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="Resource"/> entity instances using the 'GetResources' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="Resource"/> entity instances.</returns>
        public EntityQuery<Resource> GetResourcesQuery()
        {
            this.ValidateMethod("GetResourcesQuery", null);
            return base.CreateQuery<Resource>("GetResources", null, false, true);
        }
        ...
        public interface ISchedulerDomainServiceContract
        {
            ...
            /// <summary>
            /// Asynchronously invokes the 'GetResources' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/SchedulerDomainService/GetResourcesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/SchedulerDomainService/GetResources", ReplyAction="http://tempuri.org/SchedulerDomainService/GetResourcesResponse")]
            [WebGet()]
            IAsyncResult BeginGetResources(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetResources'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetResources'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetResources' operation.</returns>
            QueryResult<Resource> EndGetResources(IAsyncResult result);
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/SchedulerDomainService/GetSysdiagramsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/SchedulerDomainService/GetSysdiagrams", ReplyAction="http://tempuri.org/SchedulerDomainService/GetSysdiagramsResponse")]
            [WebGet()]
